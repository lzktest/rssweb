...
CREATE table if not exists public.sys_base_menus (
                                                     sys_base_menu_id bigserial NOT NULL,
...
(sys_base_menu_id, createed_at, updateed_at, deleteed_at, menu_level, parent_id, routerpath, routername, hidden, component, sort, keep_alive, default_menu, title, icon)
